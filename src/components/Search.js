    ...
    return(
        <>
            <DropdownButton
                ...
                <Dropdown.Divider />
                <Dropdown.Item href="#" onClick={()=> onOrderByChange('asc')}>Ascending Order{(orderBy == 'asc')&&<BsCheck2 className="float-end"/>}</Dropdown.Item>
                <Dropdown.Item href="#" onClick={()=> onOrderByChange('desc')}>Descending Order{(orderBy == 'desc')&&<BsCheck2 className="float-end"/>}</Dropdown.Item>
            </DropdownButton>        
        </>
    )
}
